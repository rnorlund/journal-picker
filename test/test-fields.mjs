...
const CASES = [
 ...
 ['llm-language', 'Do large language models predict human reading times? Surprisal from transformer models and self-paced reading',
  'We compared word-by-word surprisal from GPT-2, BERT and a recurrent neural network language model against human self-paced reading times and N400 amplitude in 92 native speakers. Surprisal from the transformer language model explained more variance in reading times than lexical frequency or cloze probability. We further tested sentence processing of syntactic ambiguity and found divergence between model and human predictions for garden-path constructions, suggesting large language models and human language comprehension differ in their use of working memory during incremental parsing.'],
